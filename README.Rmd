...
Below is the citation output from using `citation('chevreuldata')` in R. Please
run this yourself to check for any updates on how to cite __chevreuldata__.

```{r 'citation', eval = requireNamespace('chevreuldata')}
